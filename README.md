...
> **概念来源**：「把考证做成游戏化 NPC 任务轴」这个点子受小红书公开笔记《大学 NPC
> 任务轴》（作者：学术女工于发发）及腾讯 WorkBuddy 上的同名工作台启发，**不是本仓库
> 的原创**。原创部分是把它落成可上线小程序的全部工程实现。未使用对方的任何代码、
> 素材或托管配置。详见 `docs/submission/说明文档.md` 第七节。
